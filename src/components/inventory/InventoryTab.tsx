  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        {/* ABC 分类 */}
        <Card className="card-entrance chart-container hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300" style={{ '--delay': '0ms' } as React.CSSProperties}>
        ...
        {/* 周转天数分布 */}
        <Card className="sm:col-span-2 lg:col-span-2 card-entrance chart-container hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300" style={{ '--delay': '100ms' } as React.CSSProperties}>
          <CardHeader className="pb-2">
      ...
      {/* 滞销产品预警 */}
      {slowMoving.length > 0 && (
        <Card className="card-entrance border-amber-200 bg-amber-50 dark:bg-amber-950/20 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300" style={{ '--delay': '200ms' } as React.CSSProperties}>
          <CardHeader className="pb-2">
      ...
      {/* 库存库龄分布 */}
      <Card className="card-entrance chart-container border-l-[4px] border-l-emerald-400 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300" style={{ '--delay': '250ms' } as React.CSSProperties}>
        <CardHeader className="pb-2">
      ...
      {/* 仓库容量热力图 */}
      <Card className="card-entrance border-l-[4px] border-l-violet-400 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300" style={{ '--delay': '250ms' } as React.CSSProperties}>
      ...
      {procurementData && (procurementData as any)?.data?.items && (procurementData as any).data.items.length > 0 && (
        <Card className="card-entrance border-l-[4px] border-l-amber-400 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300" style={{ '--delay': '300ms' } as React.CSSProperties}>
      ...
      {/* 搜索和筛选 + 库存明细 */}
      <Card className="card-entrance hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300" style={{ '--delay': '300ms' } as React.CSSProperties}>
